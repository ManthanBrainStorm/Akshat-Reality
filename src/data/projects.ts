...
export const projects: Project[] = [
  {
    ...
    facts: [
      {
        label: "Project type",
        value: "Residential plotted colony",
      },
      {
        label: "Approval",
        value: "RERA approved colony (as stated in brochure)",
      },
      {
        label: "Plot sizes",
        value:
          "20x40, 20x45, 20x50 and 30x60 ft; 800, 1000, 1200 and 1500 sq ft options",
      },
      {
        label: "Segments",
        value: "Residential plots, plus L.I.G. + E.W.S. plots",
      },
      {
        label: "Internal roads",
        value: "12.0 M internal roads as per site plan",
      },
    ],
   ...
   * ============================================================
   *
   * This is intentionally a SEPARATE project from Shri Ayodhya Puram.
   *
   * We are not inventing project information here.
   * Replace the placeholder content once the client provides
   * the actual project details and media.
   */
  {
    slug: "ayodhya-puram",
    name: "Ayodhya Puram",
    ...
    shortDescription:
      "Ayodhya Puram — project details and current availability to be confirmed by Akshat Reality.",

    overview: [
      "Ayodhya Puram is a separate project from Shri Ayodhya Puram.",
      "Detailed project information will be added after confirmation from Akshat Reality.",
    ],
    ...
    pendingConfirmation:
      "Project details, location, status, specifications, images and current availability are to be confirmed by the client.",
  },

  {
    ...
    facts: [
      {
        label: "Project type",
        value: "Residential plotted development",
      },
      {
        label: "Availability",
        value: "Sold out (as stated in the company brochure)",
      },
    ],
